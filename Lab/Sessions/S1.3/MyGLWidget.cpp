...
void MyGLWidget::initializeGL ()
{
  ...
  scl = glm::vec3(0.5,0.5,0.5); // Definim la mida a escalar
...
//  glViewport (0, 0, ample, alt);
  ...
  modelTransform(); // Realitzem la transformació del model
...
void MyGLWidget::keyPressEvent(QKeyEvent *e)
{
  ...
  switch (e->key()) {
    ...
    case Qt::Key_Up :
      ...
      break;
    case Qt::Key_P :
      rotAng = rotAng + M_PI/6;
      std::cerr << "rotAng = " << rotAng << "\n";
      break;
...
void MyGLWidget::modelTransform() {
  ...
  TG = glm::scale(TG, scl);
  TG = glm::rotate(TG, rotAng, glm::vec3(0,0,1));
  std::cerr << scl[0] <<" "<< scl[1] << " " <<scl[2] << "\n";
