...
QT_MOC_LITERAL(1, 11, 7), // "getZoom"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "setZoom"
QT_MOC_LITERAL(4, 28, 3) // "num"

    },
    "MyGLWidget\0getZoom\0\0setZoom\0num"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::getZoom)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::getZoom(int _t1)
{
